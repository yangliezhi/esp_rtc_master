...
#define BSP_ES7210_CODEC_ADDR (0x80)
...
esp_err_t bsp_audio_poweramp_enable(bool enable)
{
    ...
    esp_io_expander_new_i2c_tca9554(0, BSP_IO_EXPANDER_I2C_ADDRESS, &io_expander);

    esp_io_expander_set_dir(io_expander, IO_EXPANDER_PIN_NUM_0, IO_EXPANDER_OUTPUT);

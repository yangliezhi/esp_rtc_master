...
#define my_lcd_select 1

#if my_lcd_select
#define BSP_LCD_SUB_BOARD_2_3_DE (GPIO_NUM_4)   //
#define BSP_LCD_SUB_BOARD_2_3_VSYNC (GPIO_NUM_3)
#define BSP_LCD_SUB_BOARD_2_3_HSYNC (GPIO_NUM_46)

#define BSP_LCD_SUB_BOARD_2_3_PCLK (GPIO_NUM_0) //
#define BSP_LCD_SUB_BOARD_2_3_DISP (GPIO_NUM_NC)

#define BSP_LCD_SUB_BOARD_2_3_DATA0 (GPIO_NUM_7) //
...
#define SUB_BOARD2_480_480_PANEL_60HZ_RGB_TIMING()  ST7701_480_480_PANEL_60HZ_RGB_TIMING()

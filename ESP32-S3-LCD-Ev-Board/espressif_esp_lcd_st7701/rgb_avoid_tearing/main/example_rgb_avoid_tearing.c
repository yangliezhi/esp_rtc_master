...
#define EXAMPLE_LCD_IO_RGB_DE (GPIO_NUM_4)
#define EXAMPLE_LCD_IO_RGB_PCLK (GPIO_NUM_0)

#define EXAMPLE_LCD_IO_RGB_DATA0 (GPIO_NUM_7)
#define EXAMPLE_LCD_IO_RGB_DATA1 (GPIO_NUM_11)
#define EXAMPLE_LCD_IO_RGB_DATA2 (GPIO_NUM_12)
#define EXAMPLE_LCD_IO_RGB_DATA3 (GPIO_NUM_13)
#define EXAMPLE_LCD_IO_RGB_DATA4 (GPIO_NUM_14)

#define EXAMPLE_LCD_IO_RGB_DATA5 (GPIO_NUM_21)
#define EXAMPLE_LCD_IO_RGB_DATA6 (GPIO_NUM_47)
#define EXAMPLE_LCD_IO_RGB_DATA7 (GPIO_NUM_48)
#define EXAMPLE_LCD_IO_RGB_DATA8 (GPIO_NUM_15)
#define EXAMPLE_LCD_IO_RGB_DATA9 (GPIO_NUM_38)
#define EXAMPLE_LCD_IO_RGB_DATA10 (GPIO_NUM_39)

#define EXAMPLE_LCD_IO_RGB_DATA11 (GPIO_NUM_40)
#define EXAMPLE_LCD_IO_RGB_DATA12 (GPIO_NUM_41)
#define EXAMPLE_LCD_IO_RGB_DATA13 (GPIO_NUM_42)
#define EXAMPLE_LCD_IO_RGB_DATA14 (GPIO_NUM_2)
#define EXAMPLE_LCD_IO_RGB_DATA15 (GPIO_NUM_1)

#define EXAMPLE_LCD_IO_SPI_CS (IO_EXPANDER_PIN_NUM_1)
#define EXAMPLE_LCD_IO_SPI_SCL (IO_EXPANDER_PIN_NUM_2)
#define EXAMPLE_LCD_IO_SPI_SDA (IO_EXPANDER_PIN_NUM_3)
...
#define EXAMPLE_PIN_NUM_TOUCH_SDA (GPIO_NUM_17)
...
void app_main()
{
    ...
    spi_line_config_t line_config = {
        ...
        .sda_gpio_num = EXAMPLE_LCD_IO_SPI_SDA,
        .io_expander = expander, // Set to NULL if not using IO expander
    };
